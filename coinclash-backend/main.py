...
# Mount routers
from routers import health, auth, payment, banks, withdrawal, game, profile, bonus, referral, leaderboard, admin, tournament, gift
...
app.include_router(gift.router, prefix="/api/gift", tags=["gift"])
